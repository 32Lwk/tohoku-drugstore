...
STANDALONE_REGIONS = [
    ...
    },
    {
        "id": "hokkaido",
        "title": "北海道",
        "subtitle": "北海道内のドラッグストア調査",
        "source": ROOT / "prefectures" / "09_北海道" / "maps",
        "maps": [
            ("北海道ドラッグストア地図.html", "北海道ドラッグストア地図", "チェーン別店舗位置（ピンマップ）"),
            ("北海道ドラッグストア密度コロプレスマップ.html", "北海道ドラッグストア密度コロプレスマップ", "市区町村別の店舗密度"),
            ("北海道高齢化率コロプレスマップ.html", "北海道高齢化率コロプレスマップ", "市区町村別の高齢化率"),
        ],
    },
]
